...
present_value = future_value / (1 + .2/12) ** 9
...
def calculate_present_value(future_value, remaining_months, annual_discount_rate):
    pv = new_loan["future_value"] / (1 + annual_discount_rate/12)** new_loan["remaining_months"] 
    return pv
...
print(f"The present value of the loan is:" , {cpv})


#def calculate_present_value(future_value, remaining_months, int(0.2)):
  #  cpv = new_loan["future_value"] / (1 + 0.2/12)** new_loan["remaining_months"] 
   # return cpv
   # REVIEW WHY THIS DOESN"T WORK BY INPUTTING THE 0.2 instead of annual+discount_rate..??
